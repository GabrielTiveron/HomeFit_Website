...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { age: @trainer.age, client_id: @trainer.client_id, formation: @trainer.formation, institution: @trainer.institution, name: @trainer.name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { age: @trainer.age, client_id: @trainer.client_id, formation: @trainer.formation, institution: @trainer.institution, name: @trainer.name } }
